...
This repository contains the open-source uptime monitor and status page for [Spare](https://tryspare.com), powered by [Upptime](https://github.com/upptime/upptime).
...
With [Upptime](https://upptime.js.org), you can get your own unlimited and free uptime monitor and status page, powered entirely by a GitHub repository. We use [Issues](https://github.com/spare-technologies/status/issues) as incident reports, [Actions](https://github.com/spare-technologies/status/actions) as uptime monitors, and [Pages](https://spare-technologies.github.io/status) for the status page.
